...
namespace ProjectTrackingAPI.Models
{
    public class ManagerCommentsRepository
    {
        ...
        {
            var query = from comments in dataContext.ManagerComments select comments;
            return query.ToList ( );
        }
        public static ManagerComment GetManagerComment(int ManagerCommentID )
        {
            var query = from comments in dataContext.ManagerComments where comments.ManagerCommentID == ManagerCommentID select comments;
        ...
        public static List<ManagerComment> UpdateManagerComment(ManagerComment comment )
        {
            var managerComment = (from comments in dataContext.ManagerComments where comments.ManagerCommentID == comment.ManagerCommentID select comments).SingleOrDefault();
